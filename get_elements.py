...
def predict_mixture(path, region_name, raw_data_dir, element):
    ...
    for i in range(4):
        ...
        var_u_prediction.save_asc(str((i + 1) * 3), choose_region['west'], choose_region['south'], choose_region['step'])
        var_v_prediction.save_asc(str((i + 1) * 3), choose_region['west'], choose_region['south'], choose_region['step'])
        var_u_prediction.post_process()
...
def predict_other_elements(path, element, region_name, raw_data_folder):
    ...
    for i in range(4):
        ...
        rollPrediction.save_asc(str((i + 1) * 3), choose_region['west'], choose_region['south'], choose_region['step'])
